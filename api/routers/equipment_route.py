...
@router.get("/{vessel_code}" + route_settings.equipments,tags=["Vessels"], response_model=List[EquipmentRead], status_code= status.HTTP_200_OK)
...
@router.post("/{vessel_code}" + route_settings.equipments,tags=["Vessels"], response_model=EquipmentRead, status_code= status.HTTP_201_CREATED)
...
@router.put("/{vessel_code}" + route_settings.equipments,tags=["Vessels"], response_model=EquipmentRead, status_code= status.HTTP_200_OK)
...
@router.delete("/{vessel_code}" + route_settings.equipments + "/deactivate",tags=["Vessels"], response_class=Response, status_code= status.HTTP_204_NO_CONTENT)
